  ...
  return (
    <main className="my-12">
      ...
      <section className="">
        ...
        <div className="mx-auto fixed bottom-5 left-1/2 transform -translate-x-1/2 inline-flex items-center justify-center gap-x-4 shadow-md px-5 py-3 rounded-lg bg-white">
          {transposeLvl !== 0 && (
